...
$sql = "SELECT id_usuario FROM tb_usuario WHERE email = ? LIMIT 1";
$stmt_id = $con->prepare($sql);
            ...
            try {
                ...
                $mail->Body = '
                        ...
                        <body>
                            ...
                            <p style="font-size: 30px; font-weight: bold;">'.$token.'</p>
                ...
                if($mail->send()) {
                    header("Location: inserir-codigo.php");
                    exit;
                } else {
